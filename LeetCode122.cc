...
//
//  Analysis:
//  On any day if the price is greater than the price on the previous day, sum up the difference
...
//  -> therefore, just use greedy algorithm, loop through whole array and calculate difference between
//      each day. add to the sum if the price on the next day is higher
//
